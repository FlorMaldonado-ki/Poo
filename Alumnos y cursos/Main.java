public class Main {
    public static void main(String[] args) {
        ...
        estudiante.setNombre("Flor de María Maldonado Ramírez");
        estudiante.setID(20052923);

        Estudiante estudiante1=new Estudiante();
        estudiante1.setNombre("Daniel Alejandro Chirino Delgado");
        estudiante1.setID(20072923);

        Estudiante estudiante2=new Estudiante();
        estudiante2.setNombre("Carlos Alberto Sánchez Guerra");
        estudiante2.setID(20002923);

        Curso curso=new Curso("Cálculo Integral", "Aburto Bedolla Alejandro", 3535);
        Curso curso1=new Curso("POO", "Eder Rivera Cisneros", 6546);
        Curso curso2=new Curso("Inglés", "Federico Esteban Cortés Estrada", 3536);
        Curso curso3=new Curso("Álgebra linela", "Erick Mauricio Cuevas Ramírez", 53453);
