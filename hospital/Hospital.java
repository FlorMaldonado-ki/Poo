...
public class Hospital {
    ...
    public Hospital(){
        Admin admin = new Admin("A2024ADMIN", "Admin", "Default",  LocalDate.now(),
                "4433805766","admin2024@hotmail.com", "HolaAdmin",
    ...
    public boolean validarNumeroTelefono(String telefonoDeseado) {
        if (validador.validarTelefono(telefonoDeseado, this.listaUsuarios)) return false;
        return true;
    }
    public boolean valiadarEmail(String emailDeseado) {
        if (validador.validarEmail(emailDeseado, this.listaUsuarios)) return false;
        return true;
    }
    ...
    public String obtenerFechaNacientoUsuario(String tipoUsuario) {
