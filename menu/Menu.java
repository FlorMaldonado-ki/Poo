...
public class Menu {
    ...
    private final String USUARIO_PACIENTE="Juan";
    private final String CONTRASEÑA_PACIENTE="12345*";

    private final String USUARIO_MEDICO="Carlos";
    private final String CONTRASEÑA_MEDICO="CarAccident";

    private final String USUARIO_ADMIN="Flor";
    private final String CONTRASEÑA_ADMIN="teAmoEunwoo_";
    ...
    public void login(){
        ...
        while(intentosUsuario<intentosMaximos){
            ...
            if (usuario.equals(this.USUARIO_PACIENTE)){
                ...
                if(contraseña.equals(this.CONTRASEÑA_ADMIN)){
    ...
    private void mostrarMenuPaciente(){
        ...
        while (opc!=2){
            ...
            switch (opc){
                case 1:
                    System.out.println("\n--------MOSTRAR CONSULTAS--------");
                    System.out.print("Ingresa el ID del paciente del que desea revisar las consultas: ");
                    String id= leer.next();
                    hospital.mostrarConsultasParaPayMed(id);
                    break;
                case 2:
                    System.out.println("\nSaliendo...\n");
                    break;
        ...
        while (opc!=4) {
            ...
            opc = leer.nextInt();
                ...
                switch (opc) {
                    ...
                    case 1:
                        System.out.println("\n--------MOSTRAR CONSULTAS--------");
                        System.out.print("Ingresa el ID del médico del que desea revisar las consultas: ");
                        String id= leer.next();
                        hospital.mostrarConsultasParaPayMed(id);
                        break;
