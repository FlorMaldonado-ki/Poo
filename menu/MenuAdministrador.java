...
public class MenuAdministrador {
        ...
        int piso, numeroCons, año, mes, dia;
            ...
            switch(opc) {
                ...
                case 1:
                    ...
                    String contraseña = datosPaciente.get(5);
                    ...
                    Paciente paciente = new Paciente(id, nombre, apellidos, fechaNacimientoPaciente,
                            telefono, email, tipoSangre, sexo, contraseña);
                ...
                case 2:
                    ...
                    email=datosMedico.get(4);
                    contraseña = datosMedico.get(5);
                    ...
                    Medico medico=new Medico(id, nombre, apellidos, fechaNacimientoMedico, telefono, email, rfc, contraseña);
    ...
    private ArrayList<String> obtenerDatosComun(Rol rol, Hospital hospital) {
        ...
        String fechaDeNacimiento= hospital.obtenerFechaNacientoUsuario(tipoUsuario);
        datosEnComun.add(fechaDeNacimiento);
        ...
        while(hospital.valiadarEmail(email)){

            if(hospital.valiadarEmail(email)){
                System.out.println("Este email ya existe. Por favor ingresa uno diferente.");
                System.out.print("Ingresar email: ");
                email = leer.next();

                hospital.valiadarEmail(email);
            }
        }
